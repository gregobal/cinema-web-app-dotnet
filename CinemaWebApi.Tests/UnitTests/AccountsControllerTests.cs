...
public class AccountsControllerTests: BaseTests
{
    [TestMethod]
        ...
        public async Task UserCanNotLogin()
        {
            ...
            var userInfo = new UserInfo() { EmailAddress = "example@mail.com", Password = "badPassword" };
        ...
        public async Task UserCanLogin()
        {
            ...
            var controller = BuildAccountsController(databaseName);
            var userInfo = new UserInfo() { EmailAddress = "example@mail.com", Password = "Aa123456!" };
            var response = await controller.Login(userInfo);
        ...
        private static UserManager<TUser> BuildUserManager<TUser>(IUserStore<TUser> store) where TUser : class
        {
